...
const InvoiceListTableProSemipaye = () => {
  const { data = [] } = useFetchFacturesProQuery();
  const payefacture = data.filter((facture) => facture.statusFacture === 1);
...
export default InvoiceListTableProSemipaye;
