...
const InvoiceListTableSemiPaye = () => {
  const { data = [] } = useFetchAllFactureQuery();
  const semipayefacture = data.filter((facture) => facture.statusFacture === 1);
...
export default InvoiceListTableSemiPaye;
