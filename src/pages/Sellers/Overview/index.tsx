...
const SellersOverview = () => {
  document.title =
    "Overview - Sellers | Toner eCommerce + Admin React Template";
  const LocationFournisseur = useLocation();

  console.log(LocationFournisseur);
  return (
    <React.Fragment>
        ...
        <Container fluid={true}>
                  ...
                  <Row className="justify-content-between gy-4">
                    <Col xl={5} md={7}>
                      <h5 className="mb-2">
                        ...
                        <i className="ph-circle-wavy-check-fill text-primary align-top fs-15"></i>
                      </h5>
                      <p>
                        <b>Since: 2015</b>. Selling clothes & Other Accessories
                      </p>
              ...
              <Col key={key}>
                <Card className="overflow-hidden element-item">
                  <div className="bg-light py-4">
                    ...
                    {item.isBestArrival && (
                      <p className="fs-12 fw-medium badge bg-danger py-2 px-3 product-lable mb-0 align-middle">
                        Best Arrival
                      </p>
                    )}
                    <div className="gallery-product-actions">
                      <div className="mb-2">
                        <Button
                          variant="danger"
                          className="avatar-xs custom-toggle"
                          data-bs-toggle="button"
                          onClick={(e) => bookmarkProduct(e)}
                        >
                    ...
                    <div>
                      <ul className="clothe-colors list-unstyled hstack gap-1 mb-3 flex-wrap d-none">
                        <li>
                          ...
                          />
                          <label
                            className="avatar-xxs border border-2 border-white btn btn-success p-0 d-flex align-items-center justify-content-center rounded-circle"
                        ...
                        <li>
                          ...
                          />
                          <label
                            className="avatar-xxs border border-2 border-white btn btn-info p-0 d-flex align-items-center justify-content-center rounded-circle"
                        ...
                        <li>
                          ...
                          />
                          <label
                            className="avatar-xxs border border-2 border-white btn btn-warning p-0 d-flex align-items-center justify-content-center rounded-circle"
                        ...
                        <li>
                          ...
                          />
                          <label
                            className="avatar-xxs border border-2 border-white btn btn-danger p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="product-color-15"
                          ></label>
                        </li>
                      </ul>
                      <Link to="/product-overview">
                        <h6 className="fs-18 lh-base text-truncate mb-0 text-capitalize">
                          {item.productName}
                        </h6>
                      </Link>
                      <div className="mt-3">
                        ...
                        <h5 className="mb-0 fs-16">
                          ...
                          <span className="text-muted fs-14">
                            {item.deletePrice && <del>${item.deletePrice}</del>}
                          </span>
                        </h5>
                      </div>
                    </div>
          ...
          <Row className="g-0 text-center text-sm-start align-items-center mb-3">
            <Col sm={6}>
              <div>
                <p className="mb-sm-0">
                  Showing <b>1</b> to <b>10</b> of <b>18</b> entries
                </p>
              </div>
            </Col>
            <Col sm={6}>
