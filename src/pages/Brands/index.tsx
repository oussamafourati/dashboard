...
import { Charges, useGetAllChargesQuery } from "features/charge/chargeSlice";
...
const InvoiceList = () => {
  ...
  const [monthCharges, setMonthCharges] = useState<Charges[]>([]);
  useEffect(() => {
  ...
  const [weekCharges, setWeekCharges] = useState<Charges[]>([]);
  useEffect(() => {
    const getWeekCharges = async () => {
      const reqdata = await fetch("http://localhost:8000/charges/weekCharges");
      const resdata = await reqdata.json();
      setWeekCharges(resdata);
    };
    getWeekCharges();
  }, []);

  const [lastMonthCharges, setLastMonthCharges] = useState<Charges[]>([]);
  useEffect(() => {
    const getLastMonthCharges = async () => {
      const reqdata = await fetch("http://localhost:8000/charges/lastCharges");
      const resdata = await reqdata.json();
      setLastMonthCharges(resdata);
    };
    getLastMonthCharges();
  }, []);
  const chargeMois = monthCharges.reduce(
    (sum, i) => (sum += i.montantCharges),
    0
  );

  const chargeSemaine = weekCharges.reduce(
    (sum, i) => (sum += i.montantCharges),
    0
  );

  const chargeMoisDernier = lastMonthCharges.reduce(
    (sum, i) => (sum += i.montantCharges),
    0
  );
              ...
              <Card className="card-animate bg-info-subtle border-0 overflow-hidden">
                ...
                <Card.Body className="position-relative">
                  ...
                  <div className="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      <h4 className="fs-24 fw-semibold mb-4">
                        <CountUp end={chargeMois} decimals={2} />
                      </h4>
                    </div>
                    <div className="avatar-sm flex-shrink-0">
                      <span className="avatar-title bg-white text-primary rounded fs-3">
              ...
              <Card className="card-animate bg-info-subtle border-0 overflow-hidden">
                ...
                <Card.Body className="position-relative">
                  ...
                  <div className="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      <h4 className="fs-24 fw-semibold mb-4">
                        <CountUp end={chargeSemaine} decimals={2} />
                      </h4>
                    </div>
                    <div className="avatar-sm flex-shrink-0">
                      <span className="avatar-title bg-white text-primary rounded fs-3">
              ...
              <Card className="card-animate bg-info-subtle border-0 overflow-hidden">
                ...
                <Card.Body className="position-relative">
                  ...
                  <div className="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      <h4 className="fs-24 fw-semibold mb-4">
                        <CountUp end={chargeMoisDernier} decimals={2} />
                      </h4>
                    </div>
                    <div className="avatar-sm flex-shrink-0">
                      <span className="avatar-title bg-white text-primary rounded fs-3">
