            ...
            <Col xl={8}>
              <div className="mt-5 mt-xl-0">
                    ...
                    <div className=" mt-4">
                      ...
                      <div className="d-flex flex-wrap gap-2">
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-primary"
                            disabled
                          >
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-secondary"
                          >
                            <i className="ri-checkbox-blank-circle-fill"></i>
                          </Button>
                        </div>
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-success"
                          >
                            <i className="ri-checkbox-blank-circle-fill"></i>
                          </Button>
                        </div>
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-info"
                          >
                            <i className="ri-checkbox-blank-circle-fill"></i>
                          </Button>
                        </div>
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-warning"
                          >
                            <i className="ri-checkbox-blank-circle-fill"></i>
                          </Button>
                        </div>
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-danger"
                          >
                            <i className="ri-checkbox-blank-circle-fill"></i>
                          </Button>
                        </div>
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-light"
                          >
                            <i className="ri-checkbox-blank-circle-fill"></i>
                          </Button>
                        </div>
                        ...
                        >
                          <Button
                            variant="white"
                            className="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-24 text-dark"
                          >
                            <i className="ri-checkbox-blank-circle-fill"></i>
                          </Button>
                        </div>
                ...
                <div className="mt-4 text-muted">
                  ...
                  <p>
                    Long sleeve T-shirts are as the name suggests,{" "}
                    <b>
                      T-shirts with their sleeves extended to cover the entire
                      arm up to the wrist
                    </b>
                    . These shirts combine the casual and comfortable feel of a
                    T-shirt with the full covering of a business/dress shirt. I
                    won't say not to wear these colors, but these colors don't
                    compliment your skin tone the best. Wear warm colors.
                  </p>
                  <p>
                    <b>Whites</b>, <b>pastels</b>, <b>shades of purple</b>,{" "}
                    <b>pink</b>, <b>rich yellow</b>, and <b>orange</b> look good
                    with your skin. The colors dark skin men should avoid are
                    black or dark brown.
                  </p>
                </div>
                        ...
                        <Col className="col-auto">
                          <div>
                            <h6 className="mb-0 text-muted fs-13">
                              <i className="ri-star-fill text-warning me-1 align-bottom"></i>
                              5
                            </h6>
                          </div>
                        </Col>
                        ...
                        <div className="d-flex mb-3">
                          <div className="flex-grow-1">
                            <div>
                              <div className="mb-2 fs-12">
                                ...
                                <span>
                                  {" "}
                                  <i className="ri-star-line text-warning align-bottom"></i>
                                </span>
                                <span>
                                  {" "}
                                  <i className="ri-star-line text-warning align-bottom"></i>
                          ...
                          <div className="flex-shrink-0">
                            <p className="mb-0 text-muted">
                              <i className="ri-calendar-event-fill me-2 align-middle"></i>
                              Oct 28, 2023
                            </p>
                          </div>
                        </div>
                    ...
                    <div>
                      <form action="#" className="form">
                        ...
                        <div className="text-end">
                          ...
                          >
                            Send Review{" "}
                            <i className="ri-send-plane-2-line align-bottom ms-1"></i>
                          </Button>
                        </div>
                      </form>
                    </div>
